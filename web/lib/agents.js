...
export const SYSTEM_AGENTS = [
  ...
  },
  {
    ...
    emoji: "▶",
    description: "Shorts verticales nativos con Mateo y Lucia: hook fuerte, ritmo rapido, cinco escenas y CTA para convertir espectadores en suscriptores.",
    category: "podcast",
    ...
    durationProfiles: [
      { id: "shorts75", label: "75 s", description: "Short nativo: 5 escenas de 15 segundos, voz 1.25x y cierre de suscripcion.", targetSeconds: 75 },
    ],
    exampleTopics: [
